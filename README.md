...
The platform is powered by six datasets, all derived from published Central Bank of Ireland NCID Reports 1 through 6.

| Dataset | Records | Description |
|---|---|---|
| `01_market_overview.csv` | 15 rows | Annual GWP, premiums, policies, claims cost, loss ratio |
| `02_claim_frequency.csv` | 30 rows | Injury and damage frequency by year, COVID impact, 2019 index |
| `03_settlement_channels.csv` | 45 rows | Channel mix, average cost per channel, cost multiple vs direct |
| `04_driver_profiles.csv` | 64 rows | 8 age bands x 8 years, frequency, severity, premium adequacy |
| `05_county_risk.csv` | 26 rows | County loss ratio, vs national, risk tier, pricing signal |
| `06_pig_impact.csv` | 6 rows | Annual PIG saving, cumulative saving, cost reduction per claim |
...
│   ├── 01_market_overview.csv
│   ├── 02_claim_frequency.csv
│   ├── 03_settlement_channels.csv
│   ├── 04_driver_profiles.csv
│   ├── 05_county_risk.csv
│   └── 06_pig_impact.csv
├── sql/
│   ├── 01_schema.sql
